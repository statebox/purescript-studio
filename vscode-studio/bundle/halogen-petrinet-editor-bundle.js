...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Data.NLL"] = $PS["Data.NLL"] || {};
  var exports = $PS["Data.NLL"];
  var Control_Applicative = $PS["Control.Applicative"];
  ...
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];                
  var splitOn = function (dictEq) {
      return function (sep) {
          return function (xs) {
              var finish = function (v) {
                  var $6 = Data_Foldable["null"](Data_Foldable.foldableArray)(v.lip);
                  if ($6) {
                      return v.acc;
                  };
                  return Data_Array.snoc(v.acc)(v.lip);
              };
              var f1 = function (separator) {
                  return function (v) {
                      return function (elem) {
                          var $12 = Data_Eq.eq(dictEq)(elem)(separator);
                          if ($12) {
                              return {
                                  acc: Data_Array.snoc(v.acc)(v.lip),
                                  lip: [  ]
                              };
                          };
                          return {
                              acc: v.acc,
                              lip: Data_Array.snoc(v.lip)(elem)
                          };
                      };
                  };
              };
              return finish(Data_Foldable.foldl(Data_Foldable.foldableArray)(f1(sep))({
                  acc: [  ],
                  lip: [  ]
              })(xs));
          };
  ...
  var map2aryTo2elemList = function (f) {
      return function (xs) {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              if (v1 instanceof Data_Maybe.Just && v1.value0.tail.length === 0) {
                  return new Data_Maybe.Just(f(v.value0.head)(v1.value0.head));
              };
              if (v1 instanceof Data_Maybe.Just) {
                  return Data_Maybe.Nothing.value;
              };
              throw new Error("Failed pattern match at Data.NLL (line 62, column 40 - line 65, column 83): " + [ v1.constructor.name ]);
          };
          throw new Error("Failed pattern match at Data.NLL (line 60, column 27 - line 65, column 83): " + [ v.constructor.name ]);
      };
  };
  var mapWindow2 = function (f) {
      return function (xs) {
          var rest = Data_Array.drop(2)(xs);
          var init = Data_Array.take(2)(xs);
          if (xs.length === 0) {
              return [  ];
          };
          return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(Control_Applicative.pure(Control_Applicative.applicativeArray))(map2aryTo2elemList(f)(init)))(mapWindow2(f)(rest));
      };
  };
  exports["splitOn"] = splitOn;
  exports["mapWindow2"] = mapWindow2;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
...
})(PS["Data.Petrinet.Representation.Layout.Dagre"] = PS["Data.Petrinet.Representation.Layout.Dagre"] || {});
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Data.Petrinet.Representation.Layout.Dagre"] = $PS["Data.Petrinet.Representation.Layout.Dagre"] || {};
  var exports = $PS["Data.Petrinet.Representation.Layout.Dagre"];
  var $foreign = $PS["Data.Petrinet.Representation.Layout.Dagre"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_FoldableWithIndex = $PS["Data.FoldableWithIndex"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Map_Internal = $PS["Data.Map.Internal"];
  ...
  var Data_Vec3_Vec3 = $PS["Data.Vec3.Vec3"];
  var Foreign_Object = $PS["Foreign.Object"];                
  var layout = function (dictOrd) {
      return function (dictShow) {
          return function (dictOrd1) {
              return function (dictShow1) {
                  return function (net) {
                      var toMap = function (dictShow2) {
                          return function (dictOrd2) {
                              return function (ids) {
                                  return function (points) {
                                      return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Data_Map_Internal.monoidMap(dictOrd2))(function (i) {
                                          return Data_Foldable.foldMap(Data_Foldable.foldableMaybe)(Data_Map_Internal.monoidMap(dictOrd2))(function (v) {
                                              return Data_Map_Internal.singleton(i)(Data_Vec3_Vec3.vec2(Data_Semiring.semiringNumber)(v.x / 4.0)(v.y / 4.0));
                                          })(Foreign_Object.lookup(Data_Show.show(dictShow2)(i))(points));
                                      })(ids);
                                  };
                              };
                          };
                      ...
                      var input = {
                          places: Data_Functor.mapFlipped(Data_Functor.functorArray)(net.places)(Data_Show.show(dictShow)),
                          transitions: Data_Functor.mapFlipped(Data_Functor.functorArray)(tids)(Data_Show.show(dictShow1)),
                          edges: Data_FoldableWithIndex.foldMapWithIndex(Data_Map_Internal.foldableWithIndexMap)(Data_Monoid.monoidArray)(function (tid) {
                              return function (v) {
                                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                                      return {
                                          source: Data_Show.show(dictShow)(v1.place),
                                          target: Data_Show.show(dictShow1)(tid)
                                      };
                                  })(v.pre))(Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                                      return {
                                          source: Data_Show.show(dictShow1)(tid),
                                          target: Data_Show.show(dictShow)(v1.place)
                                      };
                                  })(v.post));
                              };
                          })(net.transitionsDict)
                      };
                      var output = $foreign.dagreLayout(input);
                      return {
                          placePointsDict: toMap(dictShow)(dictOrd)(net.places)(output.places),
                          transitionPointsDict: toMap(dictShow1)(dictOrd1)(tids)(output.transitions)
                      };
                  };
              };
          };
...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Data.Petrinet.Representation.NLL"] = $PS["Data.Petrinet.Representation.NLL"] || {};
  var exports = $PS["Data.Petrinet.Representation.NLL"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Either = $PS["Data.Either"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Int = $PS["Data.Int"];
  var Data_NLL = $PS["Data.NLL"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Set = $PS["Data.Set"];
  var Data_Tuple = $PS["Data.Tuple"];                
  var ErrOddLength = (function () {
      function ErrOddLength() {

      };
      ErrOddLength.value = new ErrOddLength();
      return ErrOddLength;
  })();
  var uniquePlaceIds = function (dictOrd) {
      return function (dictEq) {
          return function (net) {
              return Data_Set.fromFoldable(Data_Foldable.foldableArray)(dictOrd)(Control_Bind.bindFlipped(Control_Bind.bindArray)(Data_Tuple.uncurry(Data_Semigroup.append(Data_Semigroup.semigroupArray)))(net));
          };
      };
  };
  var fromNLL = function (dictEq) {
      return function (separator) {
          return function (xs) {
              var ys = Data_NLL.splitOn(dictEq)(separator)(xs);
              var $9 = Data_Int.even(Data_Array.length(ys));
              if ($9) {
                  return Data_Either.Right.create(Data_NLL.mapWindow2(Data_Tuple.Tuple.create)(ys));
              };
              return new Data_Either.Left(ErrOddLength.value);
          };
      };
  };
  var fromNLLMaybe = function (dictEq) {
      return function (separator) {
          var $12 = fromNLL(dictEq)(separator);
          return function ($13) {
              return Data_Either.hush($12($13));
          };
      };
  };
  exports["fromNLLMaybe"] = fromNLLMaybe;
  exports["uniquePlaceIds"] = uniquePlaceIds;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
                          ...
                          return function (transitionTypes) {
                              return function (transitionAuths) {
                                  ...
                                  var labelTransitionsWith = (function () {
                                      var $11 = Data_Map_Internal.fromFoldable(Data_Ord.ordInt)(Data_Foldable.foldableArray);
                                      var $12 = zipWithIndexFrom(firstTransitionIndex);
                                      return function ($13) {
                                          return $11($12($13));
                                      };
                                  })();
  ...
  var mkNetInfo = function (net) {
      return function (name) {
          return function (textBoxes) {
              return {
                  name: name,
                  net: net,
                  textBoxes: textBoxes,
  ...
  var mkLayout = function (firstTransitionIndex) {
      return function (placePoints) {
          return function (transitionPoints) {
              return {
                  placePointsDict: Data_Map_Internal.fromFoldable(Data_Ord.ordInt)(Data_Foldable.foldableArray)(placePoints),
                  transitionPointsDict: Data_Map_Internal.fromFoldable(Data_Ord.ordInt)(Data_Foldable.foldableArray)(zipWithIndexFrom(firstTransitionIndex)(transitionPoints))
              };
          };
      };
  };
  var mkNetRep = function (pids) {
      return function (transitions) {
          return function (marking) {
              return function (placeLabels) {
                  return function (placePoints) {
                      return function (transitionLabels) {
                          return function (transitionTypes) {
                              return function (transitionPoints) {
                                  return function (transitionAuths) {
                                      var firstTransitionIndex = Data_Array.length(pids) + 1 | 0;
                                      var layout = Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(mkLayout)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)(firstTransitionIndex)))(placePoints))(transitionPoints);
                                      return mkNetRepUsingLayout(pids)(transitions)(marking)(placeLabels)(transitionLabels)(layout)(transitionTypes)(transitionAuths);
                                  };
                              };
                          };
                      };
  ...
  var mapPoints = function (f) {
      return function (v) {
          return {
              layout: Data_Petrinet_Representation_Layout.mapVec2D(f)(v.layout),
              textBoxes: Data_Functor.map(Data_Functor.functorArray)(mapTextBoxF(f))(v.textBoxes)
          };
      };
  };
  var boundingBox = function (v) {
      var textBoxesBounds = Data_Vec3_Vec3.bounds(Data_Bounded.boundedNumber)(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(Control_Bind.bindFlipped(Control_Bind.bindArray)(function ($14) {
          return Data_Vec3_Box.toArray((function (v1) {
              return v1.box;
          })($14));
      })(v.textBoxes));
      var layoutBounds = Data_Petrinet_Representation_Layout.bounds(v.layout);
  ...
  exports["mkNetRep"] = mkNetRep;
  exports["mkNetInfo"] = mkNetInfo;
...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["View.Petrinet.Model.NLL.CopyHackTodo"] = $PS["View.Petrinet.Model.NLL.CopyHackTodo"] || {};
  var exports = $PS["View.Petrinet.Model.NLL.CopyHackTodo"];
  var Data_Array = $PS["Data.Array"];
  var Data_Bag = $PS["Data.Bag"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var Data_Monoid_Additive = $PS["Data.Monoid.Additive"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Petrinet_Representation_NLL = $PS["Data.Petrinet.Representation.NLL"];
  var Data_Semiring = $PS["Data.Semiring"];
  var Data_Set = $PS["Data.Set"];
  var Data_Unfoldable = $PS["Data.Unfoldable"];
  var View_Petrinet_Model = $PS["View.Petrinet.Model"];                
  var toNetRep = function (net) {
      return function (placeNames) {
          return function (transitionNames) {
              return function (typedefs) {
                  return function (roles) {
                      var places = Data_Set.toUnfoldable(Data_Unfoldable.unfoldableArray)(Data_Petrinet_Representation_NLL.uniquePlaceIds(Data_Ord.ordInt)(Data_Eq.eqInt)(net));
                      var numPlaces = Data_Array.length(places);
                      var mkTransition = function (v) {
                          return {
                              pre: Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                                  return {
                                      place: v1,
                                      tokens: 1
                                  };
                              })(v.value0),
                              post: Data_Functor.map(Data_Functor.functorArray)(function (v1) {
                                  return {
                                      place: v1,
                                      tokens: 1
                                  };
                      ...
                      var transitions = Data_Functor.map(Data_Functor.functorArray)(mkTransition)(net);
                      var pids = Data_Array.range(1)(numPlaces);
                      var placeNamesIndexed = Data_Array.zip(pids)(placeNames);
                      return View_Petrinet_Model.mkNetRep(places)(transitions)(Data_Monoid.mempty(Data_Bag.monoidBagF(Data_Bag.semigroupBagF(Data_Ord.ordInt)(Data_Monoid_Additive.semigroupAdditive(Data_Semiring.semiringInt)))))(placeNamesIndexed)(Data_Maybe.Nothing.value)(transitionNames)(typedefs)(Data_Maybe.Nothing.value)(roles);
                  };
              };
          };
      };
  };
  var toNetRepWithDefaults = function (net) {
      return function (placeNames) {
          return function (transitionNames) {
              var typedefs = Data_Functor.voidRight(Data_Functor.functorArray)("1")(net);
              return toNetRep(net)(placeNames)(transitionNames)(typedefs)(Data_Monoid.mempty(Data_Monoid.monoidArray));
          };
      };
  };
  var toNetInfoWithDefaults = function (net) {
      return function (name) {
          return function (placeNames) {
              return function (transitionNames) {
                  var netRep = toNetRepWithDefaults(net)(placeNames)(transitionNames);
                  return View_Petrinet_Model.mkNetInfo(netRep)(name)(Data_Monoid.mempty(Data_Monoid.monoidArray));
              };
          };
      };
  };
  exports["toNetInfoWithDefaults"] = toNetInfoWithDefaults;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
...
(function($PS) {
  ...
  var Data_Ord = $PS["Data.Ord"];
  var Data_Petrinet_Representation_Dict = $PS["Data.Petrinet.Representation.Dict"];
  var Data_Petrinet_Representation_Layout_Dagre = $PS["Data.Petrinet.Representation.Layout.Dagre"];
  var Data_Petrinet_Representation_Marking = $PS["Data.Petrinet.Representation.Marking"];
  var Data_Ring = $PS["Data.Ring"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Semiring = $PS["Data.Semiring"];
  ...
  var toggleMaybe = function (z) {
      return function (mx) {
          ...
          throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 539, column 20 - line 541, column 21): " + [ mx.constructor.name ]);
      };
  };
                  ...
                  return function (dictShow1) {
                      return function (htmlIdPrefixMaybe) {
                          ...
                          var mkTransitionIdStr = (function () {
                              var $180 = Data_Semigroup.append(Data_Semigroup.semigroupString)(netPrefix);
                              return function ($181) {
                                  return $180(prefixTransition($181));
                              };
                          })();
                          var mkPlaceIdStr = (function () {
                              var $182 = Data_Semigroup.append(Data_Semigroup.semigroupString)(netPrefix);
                              return function ($183) {
                                  return $182(prefixPlace($183));
                              };
                          })();
                          var svgPlace = function (v) {
                              ...
                              return Svg_Elements.g([ Svg_Attributes.id(mkPlaceIdStr(v.id)), Halogen_HTML_Events.onClick(function (v1) {
                                  return Data_Maybe.Just.create(new View_Petrinet_Model.FocusPlace(v.id));
                          ...
                          var arcAnimationClass = function (tid) {
                              return function (isPost) {
                                  var prefix = function (v) {
                                      ...
                                      throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 482, column 9 - line 482, column 34): " + [ v.constructor.name ]);
                                  };
                          ...
                          var handleAction = function (v) {
                              ...
                              if (v instanceof View_Petrinet_Model.FocusPlace) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      ...
                                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                          ...
                                          $86.focusedPlace = focusedPlace$prime;
                                          $86.msg = Data_Maybe.maybe("Focused")(Data_Function["const"]("Unfocused"))(v1.focusedPlace) + (" place " + (Data_Show.show(dictShow)(v.value0) + (" (" + (Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(Data_Map_Internal.lookup(dictOrd)(v.value0)(v1.netInfo.net.placeLabelsDict)) + ")."))));
                                          return $86;
                                      })());
                                  });
                              };
                              if (v instanceof View_Petrinet_Model.UpdatePlace) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                      ...
                                      $96.netInfo = (function () {
                                          var $93 = {};
                                          for (var $94 in state.netInfo) {
                                              if ({}.hasOwnProperty.call(state.netInfo, $94)) {
                                                  $93[$94] = state["netInfo"][$94];
                                              };
                                          };
                                          $93.net = (function () {
                                              var $90 = {};
                                              for (var $91 in state.netInfo.net) {
                                                  if ({}.hasOwnProperty.call(state.netInfo.net, $91)) {
                                                      $90[$91] = state["netInfo"]["net"][$91];
                                                  };
                                              };
                                              $90.placeLabelsDict = Data_Map_Internal.insert(dictOrd)(v.value0.value0)(v.value0.value1)(state.netInfo.net.placeLabelsDict);
                                              return $90;
                                          })();
                                          return $93;
                                      })();
                                      $96.msg = "Updated place " + (Data_Show.show(dictShow)(v.value0.value0) + ".");
                                      return $96;
                                  });
                              };
                                  ...
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                      ...
                                      $108.netInfo = (function () {
                                          ...
                                          $105.net = (function () {
                                              ...
                                              $102.transitionLabelsDict = Data_Map_Internal.insert(dictOrd1)(v.value0.value0)(v.value0.value1)(state.netInfo.net.transitionLabelsDict);
                                              return $102;
                                          })();
                                          return $105;
                                      })();
                                      $108.msg = "Updated transition " + (Data_Show.show(dictShow1)(v.value0.value0) + ".");
                                      return $108;
                                  });
                              };
                                  ...
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                                      ...
                                      $120.netInfo = (function () {
                                          ...
                                          $117.net = (function () {
                                              ...
                                              $114.transitionTypesDict = Data_Map_Internal.insert(dictOrd1)(v.value0.value0)(v.value0.value1)(state.netInfo.net.transitionTypesDict);
                                              return $114;
                                          })();
                                          return $117;
                                      })();
                                      $120.msg = "Updated transition " + (Data_Show.show(dictShow1)(v.value0.value0) + ".");
                                      return $120;
                                  });
                              };
                              if (v instanceof View_Petrinet_Model.FocusTransition) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      ...
                                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                          ...
                                          $127.focusedTransition = focusedTransition$prime;
                                          $127.msg = Data_Maybe.maybe("Focused")(Data_Function["const"]("Unfocused"))(v1.focusedTransition) + (" transition " + (Data_Show.show(dictShow1)(v.value0) + (" (" + (Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(Data_Map_Internal.lookup(dictOrd1)(v.value0)(v1.netInfo.net.transitionLabelsDict)) + ")."))));
                                          return $127;
                                      })());
                                  });
                              };
                                      ...
                                      return Data_Maybe.maybe(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function (t) {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                              ...
                                              $135.netInfo = (function () {
                                                  var $132 = {};
                                                  for (var $133 in v1.netInfo) {
                                                      if ({}.hasOwnProperty.call(v1.netInfo, $133)) {
                                                          $132[$133] = v1["netInfo"][$133];
                                                      };
                                                  };
                                                  $132.net = net$prime;
                                                  return $132;
                                              })();
                                              $135.overrideMarking = new Data_Maybe.Just(marking$prime);
                                              $135.msg = "Firing transition " + Data_Show.show(dictShow1)(v.value0);
                                              return $135;
                                          })()))(function () {
                                                          ...
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Data_Monoid.guard(Effect_Aff.monoidAff(Data_Monoid.monoidUnit))(v3 > 0)(Effect_Aff.delay(Data_Time_Duration.Milliseconds(View_Petrinet_Config.arcAnimationDurationSec * 1000.0)))))(function () {
                                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v4) {
                                                                  return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                                                      ...
                                                                      $141.overrideMarking = Data_Maybe.Nothing.value;
                                                                      $141.msg = "Fired transition " + (Data_Show.show(dictShow1)(v.value0) + (" (" + (Data_Foldable.fold(Data_Foldable.foldableMaybe)(Data_Monoid.monoidString)(Data_Map_Internal.lookup(dictOrd1)(v.value0)(net$prime.transitionLabelsDict)) + ").")));
                                                                      return $141;
                                                                  })());
                                                              });
                                                          });
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                                      return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                          if (v.value0 instanceof View_Petrinet_Model.Arc) {
                                              ...
                                              $147.arcLabelsVisible = !v1.arcLabelsVisible;
                                              return $147;
                                          };
                                          if (v.value0 instanceof View_Petrinet_Model.Place) {
                                              ...
                                              $150.placeLabelsVisible = !v1.placeLabelsVisible;
                                              return $150;
                                          };
                                          if (v.value0 instanceof View_Petrinet_Model.Transition) {
                                              ...
                                              $153.transitionLabelsVisible = !v1.transitionLabelsVisible;
                                              return $153;
                                          };
                                          throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 233, column 17 - line 236, column 94): " + [ v.value0.constructor.name ]);
                                      })());
                                  });
                              };
                              throw new Error("Failed pattern match at View.Petrinet.PetrinetEditor (line 186, column 20 - line 236, column 94): " + [ v.constructor.name ]);
                          };
                          ...
                          var svgTransitionAndArcs = function (t) {
                              ...
                              return Svg_Elements.g([ Svg_Attributes.class_("css-transition" + (Data_Monoid.guard(Data_Monoid.monoidString)(t.isEnabled)(" enabled") + (" " + Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")(roleClasses)))), Svg_Attributes.id(t.htmlId), Halogen_HTML_Events.onClick(function (v) {
                                  return Data_Maybe.Just.create(new View_Petrinet_Model.FocusTransition(t.id));
                              }), Halogen_HTML_Events.onDoubleClick(function (v) {
                                  return Data_Maybe.Just.create((function () {
                                      if (t.isEnabled) {
                                          return new View_Petrinet_Model.FireTransition(t.id);
                                      };
                                      return new View_Petrinet_Model.FocusTransition(t.id);
                                  })());
                                  ...
                                  return function (focusedPlace) {
                                      return function (focusedTransition) {
                                          ...
                                          var svgTransitions = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)((function () {
                                              var $184 = Data_Functor.map(Data_Maybe.functorMaybe)(svgTransitionAndArcs);
                                              var $185 = Data_Tuple.uncurry(mkTransitionAndArcsModel);
                                              return function ($186) {
                                                  return $184($185($186));
                                              };
                                          ...
                                          var svgPlaces = Data_Array.catMaybes(Data_Functor.map(Data_Functor.functorArray)((function () {
                                              var $187 = Data_Functor.map(Data_Maybe.functorMaybe)(svgPlace);
                                              return function ($188) {
                                                  return $187(mkPlaceModel($188));
                                              };
                                          })())(v.net.places));
                          ...
                          var render = function (state) {
                              ...
                              var v = (function () {
                                  var layout = (function () {
                                      var autoLayout = Data_Petrinet_Representation_Layout_Dagre.layout(dictOrd)(dictShow)(dictOrd1)(dictShow1)(state.netInfo.net);
                                      return Data_Maybe.fromMaybe(autoLayout)(state.netInfo.net.layout);
                                  })();
                                  return View_Petrinet_Model.translateAndScale(View_Petrinet_Config.netScale)({
                                      layout: layout,
                              ...
                              var netInfo = {
                                  ...
                                  net: {
                                      layout: new Data_Maybe.Just(v.layout),
                                      marking: state.netInfo.net.marking,
                              ...
                              var bounds = View_Petrinet_Model.boundingBox({
                                  layout: v.layout,
                                  textBoxes: v.textBoxes
                              });
                              ...
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "flex" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-5/6" ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_(componentHtmlId), Halogen_HTML_Properties.classes([ "petrinet-component", "css-petrinet-component", Halogen_HTML_Core.ClassName(arcLabelsVisibilityClass + (" " + (transitionLabelsVisibilityClass + (" " + placeLabelsVisibilityClass)))) ]) ])([ Svg_Elements.svg([ Svg_Attributes.viewBox(Data_Vec3_Vec3["_x"](sceneTopLeft))(Data_Vec3_Vec3["_y"](sceneTopLeft))(Data_Vec3_Vec3["_x"](sceneSize))(Data_Vec3_Vec3["_y"](sceneSize)) ])(netToSVG(netInfo)(v.layout)(state.focusedPlace)(state.focusedTransition)), Halogen_HTML_Elements.br([  ]), Halogen_HTML_Core.text(state.msg) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "w-1/6" ]) ])((function () {
                                  ...
                                  var $189 = View_Common.mapAction(View_Petrinet_Model.UpdatePlace.create);
                                  return function ($190) {
                                      return $189(View_Petrinet_PlaceEditor["form'"]($190));
                                  };
                              })())(Control_Bind.bind(Data_Maybe.bindMaybe)(state.focusedPlace)(function (v1) {
                                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(dictOrd)(v1)(state.netInfo.net.placeLabelsDict))(function (v2) {
                                      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)({
                                          pid: v1,
                                          label: v2,
                                          typedef: "Unit",
                                  ...
                                  var $191 = View_Common.mapAction(View_Petrinet_Model.UpdateTransition.create);
                                  var $192 = View_Petrinet_TransitionEditor["form'"](state.netInfo.roleInfos);
                                  return function ($193) {
                                      return $191($192($193));
                                  };
                              })())(Control_Bind.bind(Data_Maybe.bindMaybe)(state.focusedTransition)(function (v1) {
                                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(dictOrd1)(v1)(state.netInfo.net.transitionLabelsDict))(function (v2) {
                                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(dictOrd1)(v1)(state.netInfo.net.transitionTypesDict))(function (v3) {
                                          var auths = Data_Maybe.fromMaybe(Data_Monoid.mempty(Data_Auth.monoidRoles))(Data_Map_Internal.lookup(dictOrd1)(v1)(state.netInfo.net.transitionAuthsDict));
                                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)({
                                              tid: v1,
                                              label: v2,
                                              typedef: v3,
                          ...
                          return Halogen_Component.mkComponent({
                              "eval": Halogen_Component.mkEval({
                                  ...
                                  receive: function ($194) {
                                      return Data_Maybe.Just.create(View_Petrinet_Model.LoadNet.create($194));
                                  },
...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["View.Petrinet.JsApi"] = $PS["View.Petrinet.JsApi"] || {};
  var exports = $PS["View.Petrinet.JsApi"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  ...
  var View_Petrinet_Model_NLL_CopyHackTodo = $PS["View.Petrinet.Model.NLL.CopyHackTodo"];
  var View_Petrinet_PetrinetEditor = $PS["View.Petrinet.PetrinetEditor"];                
  var runPetrinetEditorUI$prime = function (dictOrd) {
      return function (dictOrd1) {
          return function (dictShow) {
              return function (dictShow1) {
                  return function (querySelector) {
                      return function (htmlIdPrefixMaybe) {
                          return function (netInfo) {
                              return Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
                                  var netInfo$prime = Record.union()(netInfo)({
                                      roleInfos: [  ],
                                      types: [  ]
                                  });
                                  return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement(querySelector))(function (v) {
                                      return Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Effect_Aff.applicativeAff)(Halogen_VDom_Driver.runUI(View_Petrinet_PetrinetEditor.ui(Effect_Aff_Class.monadAffAff)(dictOrd)(dictShow)(dictOrd1)(dictShow1)(htmlIdPrefixMaybe))(netInfo$prime))(v);
                                  });
                              }));
                          };
                      };
  ...
  var runPetrinetEditorUI_NLL = function (querySelector) {
      return function (htmlIdPrefix) {
          return function (net) {
              var placeNames = Data_Maybe.fromMaybe([ "ERROR no place names found in Net record" ])(net.placeNames);
              var partitionM = Data_Petrinet_Representation_NLL.fromNLLMaybe(Data_Eq.eqInt)(0)(net.partition);
              var partition = Data_Maybe.fromMaybe([ new Data_Tuple.Tuple([ -1 | 0 ], [ -1 | 0 ]) ])(partitionM);
              var netInfo = View_Petrinet_Model_NLL_CopyHackTodo.toNetInfoWithDefaults(partition)(net.name)(placeNames)(net.names);
              return runPetrinetEditorUI$prime(Data_Ord.ordInt)(Data_Ord.ordInt)(Data_Show.showInt)(Data_Show.showInt)(querySelector)(new Data_Maybe.Just(htmlIdPrefix))(netInfo);
          };
      };
  };
  var main = Effect_Console.log("PetrinetEditor: JsApi.main: looks like I've been loaded!");
  exports["runPetrinetEditorUI'"] = runPetrinetEditorUI$prime;
  exports["runPetrinetEditorUI_NLL"] = runPetrinetEditorUI_NLL;
  exports["main"] = main;
})(PS);
PS["View.Petrinet.JsApi"].main();