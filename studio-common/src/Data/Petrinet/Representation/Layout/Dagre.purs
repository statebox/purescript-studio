...
foreign import dagreLayout :: ∀ pid tid. DagreInput tid pid -> DagreOutput tid pid
...
layout net =
  ...
  , edgeWaypointsDict:    output.edges # foldMap \{ tid, place, waypoints } -> Map.singleton (Tuple tid place) (map toVec3 waypoints)
  }
  where
